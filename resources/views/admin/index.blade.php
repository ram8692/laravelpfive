  ...
  <header class="header_area">
        ...
        <div class="sidebar_btn">
          <button class="sidbar-toggler-btn">
            <i class="fas fa-bars"></i>
          </button>
        </div>
        <ul class="header_menu">
          <li>
            <a href="#" class="search_btn" data-toggle="modal" data-target="#myModal">
              ...
              <ul class="dropdown_body nice_scroll scrollbar">
                <li>
                  <a href="#">
                    ...
                    <div class="text-part">
                      <h6>Madelyn <span>
                          <i class="far fa-clock"></i> today </span>
                      </h6>
                      <p>Hello Sam...</p>
                    </div>
                  </a>
            ...
            <div class="user_item dropdown-menu dropdown-menu-right">
              <div class="admin">
                <a href="#" class="user_link">
                  <img src="{{asset('panel/assets/images/admin.jpg')}}" alt="">
                </a>
              </div>
              <ul>
                <li>
          ...
          <li>
            <a class="responsive_menu_toggle" href="#">
              <i class="fas fa-bars"></i>
            </a>
          </li>
        </ul>
          ...
          <ul class="metismenu" id="menu1">
            ...
            <li class="single-nav-wrapper">
              ...
              <ul class="dashboard-menu">
                ...
                <li>
                  <a href="data_table.html">data table</a>
                </li>
              </ul>
            </li>
            <li class="single-nav-wrapper">
              ...
              <ul class="dashboard-menu">
                <li>
                  <a href="chart-float.html">Float Chart</a>
                </li>
                <li>
                  <a href="chart-float.html">Float Chart</a>
                </li>
            ...
            <li class="single-nav-wrapper">
              ...
              <ul class="dashboard-menu">
                ...
                <li>
                  <a href="icheck_toggle_pagination.html">iCheck, Toggle</a>
                </li>
                <li>
                  <a href="label-badge-alert.html">labels, Badges</a>
                </li>
                <li>
            ...
            <li class="single-nav-wrapper">
              ...
              <ul class="dashboard-menu">
                <li>
                  <a href="#">Amcharts Maps</a>
                </li>
                <li>
                  <a href="#">Data Maps</a>
                </li>
                <li>
                  <a href="#">Jvector Maps</a>
                </li>
                <li>
                  <a href="#">Google map</a>
                </li>
            ...
            <li class="single-nav-wrapper">
              ...
              <ul class="dashboard-menu">
                ...
                <li>
                  <a href="screen_lock.html">screen lock</a>
                </li>
                <li>
